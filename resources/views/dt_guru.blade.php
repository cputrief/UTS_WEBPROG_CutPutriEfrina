...
<div>
	...
	<div>
  		<h2>Data Guru <small>Admin</small></h2>
	...
	<a href="#"> <button type="button" class="btn btn-primary pull-right ti-plus">Tambah Data</button></a><br>
	{{-- isi table --}}
    <div>
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="hidden-480">
                            <span class="label label-sm label-warning">P3K</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>3</td>
                        <td>Dewi Anita<br>09674539871</td>
                        <td>Perempuan</td>
                        <td>Pembina <br>VI-A</td>
                        <td>Wali Kelas</td>
                        <td>Aceh Singkil</td>
                    ...
                    <tr>
                        ...
                        <td class="hidden-480">
                            <span class="label label-sm label-danger">Honorer</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>5</td>
                        <td>Ayu Keylia<br>09674539871</td>
                        <td>Perempuan</td>
                        <td>Pembina <br>VI-A</td>
                        <td>Wali Kelas</td>
                        <td>Aceh Singkil</td>
                        ...
                        <td class="hidden-480">
                            <span class="label label-sm label-success">PNS</span>
                        </td>
